...
if __name__ == "__main__":
    ...
    # main(depth=depth, reward_dim=4, tree_seed=TREE_SEED, dominate_seed=DOMINATE_SEED[1])
    main(depth=depth, reward_dim=6, tree_seed=TREE_SEED, dominate_seed=DOMINATE_SEED[1])
    # main(depth=depth, reward_dim=8, tree_seed=TREE_SEED, dominate_seed=DOMINATE_SEED[1])
    # main(depth=depth, reward_dim=10, tree_seed=TREE_SEED, dominate_seed=DOMINATE_SEED[1])
    # main(depth=depth, reward_dim=12, tree_seed=TREE_SEED, dominate_seed=DOMINATE_SEED[1])
